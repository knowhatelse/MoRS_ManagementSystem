...
public class AppointmentTypeRepository(MoRSManagementSystemDbContext context) : BaseRepository<AppointmentType, EmptyQuery>(context), IAppointmentTypeRepository
{

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DomainUsers_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcements_DomainUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatingDayOfWeek = table.Column<int>(type: "int", nullable: true),
                    DayOfOccurrance = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MalfunctionReports_DomainUsers_ReportedByUserId",
                        column: x => x.ReportedByUserId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MalfunctionReports_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfilePictures_DomainUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserEmails", x => new { x.EmailsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_UserEmails_DomainUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserEmails_Emails_EmailsId",
                        column: x => x.EmailsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendingAppointmentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentUser", x => new { x.AttendeesId, x.AttendingAppointmentsId });
                    table.ForeignKey(
                        name: "FK_AppointmentUser_Appointments_AttendingAppointmentsId",
                        column: x => x.AttendingAppointmentsId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentUser_DomainUsers_AttendeesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembershipFees_Payments_PaymentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Times_AppointmentSchedules_AppointmentScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentUser_AttendingAppointmentsId",
                table: "AppointmentUser",
                column: "AttendingAppointmentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DomainUsers_RoleId",
                table: "DomainUsers",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_MalfunctionReports_ReportedByUserId",
                table: "MalfunctionReports",
                column: "ReportedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MalfunctionReports_RoomId",
                table: "MalfunctionReports",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipFees_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Times_AppointmentScheduleId",
                table: "Times",
                column: "AppointmentScheduleId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserEmails_UsersId",
                table: "UserEmails",
                column: "UsersId");
        }
